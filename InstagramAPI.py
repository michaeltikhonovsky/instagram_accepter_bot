...
class InstagramAPI:
    ...
    DEVICE_SETTINGS = {'manufacturer': 'OnePlus',
                       ...
                       'android_version': 24,
                       'android_release': '7.0'}
    USER_AGENT = 'Instagram 76.0.0.15.395 Android ({android_version}/{android_release}; 380dpi; 1080x1920; {manufacturer}; {model}; OnePlus3T; qcom; en_US)'.format(**DEVICE_SETTINGS)
